 ...
 */
Ext.define('hkCRM.view.t112.T112ListController', {
    extend: 'Ext.app.ViewController',

    alias: 'controller.T112List',
    	    			...
    	    			Ext.Ajax.request( {  //
    	    	             ...
    	    	             success: function ( response, opts )
    	    	             {
    	    	                 ...
    	    	                 {    
    	    	                	 ...
    	    	                	 t112detail.lookupReference('t112MdList').getView().getStore().reload();
    	    	                	 Ext.Msg.alert( '중지처리', '처리완료' );
    	    	                 } else
    	    	                 {
    	    	                     Ext.Msg.alert( '중지처리', obj.errmsg );
    	    	                 }
    	    	             },
